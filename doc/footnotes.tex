...
\bibitem{terms} Some of these terms allow people to advocate for a policy direction, some allow them to find each other, some allow them to advocate for leaders that serve their previously-unnameable interests. See \cite{taylor2003}.
...
\bibitem{taylor} \cite{taylor2003} Taylor argues that historically, this co-option ends up undermining the power of the incumbent system.

\bibitem{effects} These effects are considered fairly well-supported in political theory and political science. [Weber, \cite{taylor2003}, some recent political scientists]
